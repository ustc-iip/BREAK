...
// 			ellips_func(&x[i*nx],&f[i],nx,OShift,M,1);
            ellips_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=-500.0;
			break;
		case 3:	
// 			bent_cigar_func(&x[i*nx],&f[i],nx,OShift,M,1);
            bent_cigar_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=-400.0;
			break;
		case 4:	
// 			discus_func(&x[i*nx],&f[i],nx,OShift,M,1);
            discus_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=-300.0;
			break;
		case 5:
...
// 			rosenbrock_func(&x[i*nx],&f[i],nx,OShift,M,1);
            rosenbrock_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=-100.0;
			break;
		case 7:	
// 			schaffer_F7_func(&x[i*nx],&f[i],nx,OShift,M,1);
            schaffer_F7_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=0.0;
			break;
		case 8:	
// 			ackley_func(&x[i*nx],&f[i],nx,OShift,M,1);
            ackley_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=100.0;
			break;
		case 9:	
// 			weierstrass_func(&x[i*nx],&f[i],nx,OShift,M,1);
            weierstrass_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=200.0;
			break;
		case 10:	
// 			griewank_func(&x[i*nx],&f[i],nx,OShift,M,1);
            griewank_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=300.0;
			break;
		case 11:	
        ...
        case 12:  // case 14
			...
			break;
        case 13:  // case 16
            katsuura_func(&x[i*nx],&f[i],nx,OShift,M,0);
			f[i]+=600.0;
			break;
//         case 14:  // case 17
