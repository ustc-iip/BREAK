function SPSO2011( run_num, func_names, func_num, options, optionalArgs )
% Framework for Standard PSO 2011 (SPSO2011).
%   Parameters:
...
if ~isfield(optionalArgs, 'nNeighbours') || (isfield(optionalArgs, 'nNeighbours') && run_num > 1)
    SPSO2011_core(run_num, func_names, func_num, options, optionalArgs);
end
