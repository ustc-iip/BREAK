...
%clear
close all;
rootDir='../../BehaviorDataCollection/BehaviorData_for_analysis/CNN_1_6g_4a_1000times_withoutdiff/';
...
saveDir=['result_CNN_visual_PCA_V_1_101_net_data6' '/' 'visualization_result_2D/'];
for L=[1,2,3,6,8,9]
