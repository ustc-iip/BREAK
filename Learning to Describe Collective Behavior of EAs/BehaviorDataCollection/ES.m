...
function ES(save_func_name, func_num, maxFEs, initial_pop, lb, ub, NP, D, runs, shift_flag)

algo_name = 'ES';

parfor run = 1:runs
    ES_run(save_func_name, func_num, algo_name, maxFEs, run, initial_pop, lb, ub, NP, D, shift_flag);
end
